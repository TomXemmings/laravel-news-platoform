						...
						<ol class="inline-flex items-center space-x-1 md:space-x-2">
							...
							<li>
								<div class="flex items-center">
									...
									<span class="ml-1 text-sm font-medium text-gray-400 md:ml-2 line-clamp-1">Неподтвержденный посты</span>
								</div>
							</li>
						</ol>
					</nav>
					<h1 class="text-xl font-semibold text-gray-900 sm:text-2xl">Неподтвержденный посты</h1>
				</div>
			</div>
		</div>
